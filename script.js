...
// Som de cursor: bip suave descendente
function sfxCursor() {
    try {
        const ctx = getCtx();
...
// Som de confirmar: dois tons ascendentes
function sfxConfirm() {
    try {
        const ctx = getCtx();
...
// Som de cancelar: tom descendente
function sfxCancel() {
    try {
        const ctx = getCtx();
        const osc  = ctx.createOscillator();
...
/* ============================================
   Iniciar música — mouse OU teclado
   ============================================ */
...
// Foco inicial após duas frames (layout estável)
